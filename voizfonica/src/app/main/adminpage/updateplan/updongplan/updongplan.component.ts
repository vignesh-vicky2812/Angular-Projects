...
@Component({
  selector: 'app-updongplan',
  templateUrl: './updongplan.component.html',
  styleUrls: ['./updongplan.component.css']
})
export class UpdongplanComponent implements OnInit {
 ...
 console.log(this.name)
   ...
   updateplan()
   {
     this._service.UpdateUserdplanFromRemote( this.id, this.plans).subscribe(
