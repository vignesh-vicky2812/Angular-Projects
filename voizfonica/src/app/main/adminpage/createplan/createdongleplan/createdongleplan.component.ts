...
@Component({
  selector: 'app-createdongleplan',
  templateUrl: './createdongleplan.component.html',
  styleUrls: ['./createdongleplan.component.css']
})
export class CreatedongleplanComponent implements OnInit {
  plans=new Plans();
  msg="";
  name;
 ...
 console.log(this.name)
   ...
   createplan()
   {
     this._service. createuserdplanFromRemote( this.plans).subscribe(
