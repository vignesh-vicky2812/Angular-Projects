...
@Component({
  selector: 'app-offerspayment',
  templateUrl: './offerspayment.component.html',
  styleUrls: ['./offerspayment.component.css']
})
export class OfferspaymentComponent implements OnInit {
...
this.plansid=_service.plansid;
 ...
 console.log(this._service.description);
 this.validity=this._service.description;
 this.data=this._service.offers;
